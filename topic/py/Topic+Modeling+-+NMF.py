...
vectorizer = text.CountVectorizer(input='filename', stop_words=veronis_french_stop_words, min_df=20,encoding=u'utf-8')
...
#    print("Topic {}: {}".format(t, ' '.join(topic.decode('utf-8') for topic in topic_words[t])))
    print "\nTopic:",t, " ",
